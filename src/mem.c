...
void initial_mem()
{
	...
	ikr2.Txr1ss=(Number *)calloc(VNMAX,sizeof(Number));
	ikr2.Ttauxr1=(Number *)calloc(VNMAX,sizeof(Number));
	if( ikr.Txr1ss==NULL || ikr.Ttauxr1==NULL || ikr.Txr2ss==NULL || ikr.Ttauxr2==NULL || ikr2.Txr1ss==NULL || ikr2.Ttauxr1==NULL ) exit(1);
...
void closed_mem()
{
	...
	free(ikr.Txr1ss); free(ikr.Ttauxr1); free(ikr.Txr2ss); free(ikr.Ttauxr2); free(ikr2.Txr1ss); free(ikr2.Ttauxr1);
