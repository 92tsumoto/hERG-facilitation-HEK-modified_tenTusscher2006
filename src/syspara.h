...
// Rapid activating potassium current (Ikr): unfacilitated fraction
struct ikrstruct {
...
// Rapid activating potassium current (Ikr): facilitated fraction
struct ikr2struct {

	double xr1,xr1ss,tauxr1;
	double *Txr1ss,*Ttauxr1;
